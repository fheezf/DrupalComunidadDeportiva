...
/*function marinelli_textfield($variables) {
  $element = $variables ['element'];
  $element ['#attributes']['type'] = 'text';
  $element ['#attributes']['placeholder'] = 'Buscar...';
  element_set_attributes($element, array('id', 'name', 'value', 'size', 'maxlength'));
  _form_set_class($element, array('text'));
  ...
  if ($element ['#autocomplete_path'] && drupal_valid_path($element ['#autocomplete_path'])) {
    ...
    $attributes ['class'][] = 'autocomplete,text';
...
function marinelli_button($variables) {
  $element = $variables ['element'];
  $element ['#attributes']['type'] = 'image';
  $element ['#attributes']['alt'] = 'submit';
  $element ['#attributes']['src'] = 'http://'.$_SERVER["SERVER_NAME"].'/comunidaddeportiva/sites/all/themes/marinelli/img/icons/searchButton.png';
